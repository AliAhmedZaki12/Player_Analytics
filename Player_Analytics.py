...
# ======================================================
SKELETON = {
    "head":      ([(0,5),(0,6)],        (0,0,255)),
    "l_arm":     ([(5,7),(7,9)],        (255,0,0)),
    "r_arm":     ([(6,8),(8,10)],       (0,255,255)),
    "torso":     ([(5,6),(5,11),(6,12),(11,12)], (255,0,255)),
    "l_leg":     ([(11,13),(13,15)],    (0,255,0)),
    "r_leg":     ([(12,14),(14,16)],    (0,165,255)),
}
